...
const TRANSLATIONS = {
  pt: {
    ...
    importDo: "Importar",
    importFileTitle: "Importar arquivo de backup",
    importFilePick: "Escolher arquivo",
    importFileDragHint: "ou arraste e solte o arquivo .json aqui",
    importFileSelected: "Arquivo selecionado",
    importFileDone: "Importação concluída!",
    importFileSuccessHint: "Os dados foram restaurados. Você pode fechar esta aba e abrir a extensão novamente.",
    importFileClose: "Fechar",
    importFileHint: "Restaura sua whitelist e seu histórico de ações exportados pelo GitHub Unfollowers.",
    importStepFile: "Arquivo",
    importStepConfirm: "Confirmar",
    importStepDone: "Concluído",
  ...
  en: {
    ...
    importFilePick: "Choose file",
    importFileDragHint: "or drag and drop the .json file here",
    importFileSelected: "Selected file",
    importFileDone: "Import complete!",
    importFileSuccessHint: "Your data has been restored. You can close this tab and reopen the extension.",
    importFileClose: "Close",
    importFileHint: "Restores your whitelist and action history exported by GitHub Unfollowers.",
    importStepFile: "File",
  ...
  zh: {
    ...
    importFilePick: "选择文件",
    importFileDragHint: "或将 .json 文件拖放到此处",
    importFileSelected: "已选择文件",
    importFileDone: "导入完成！",
    importFileSuccessHint: "您的数据已恢复。您可以关闭此标签页并重新打开扩展程序。",
    importFileClose: "关闭",
    importFileHint: "恢复由 GitHub Unfollowers 导出的白名单和操作历史。",
    importStepFile: "文件",
    importStepConfirm: "确认",
    importStepDone: "完成",
  ...
  es: {
    ...
    importDo: "Importar",
    importFileTitle: "Importar archivo de respaldo",
    importFilePick: "Elegir archivo",
    importFileDragHint: "o arrastra y suelta el archivo .json aquí",
    importFileSelected: "Archivo seleccionado",
    importFileDone: "¡Importación completada!",
    importFileSuccessHint: "Tus datos se han restaurado. Puedes cerrar esta pestaña y volver a abrir la extensión.",
    importFileClose: "Cerrar",
    importFileHint: "Restaura tu lista blanca y tu historial de acciones exportados por GitHub Unfollowers.",
    importStepFile: "Archivo",
    importStepConfirm: "Confirmar",
    importStepDone: "Completado",
  ...
  hi: {
    ...
    importDo: "आयात करें",
    importFileTitle: "बैकअप फ़ाइल आयात करें",
    importFilePick: "फ़ाइल चुनें",
    importFileDragHint: "या .json फ़ाइल को यहाँ खींचकर छोड़ें",
    importFileSelected: "चयनित फ़ाइल",
    importFileDone: "आयात पूर्ण हुआ!",
    importFileSuccessHint: "आपका डेटा बहाल कर दिया गया है। आप इस टैब को बंद करके एक्सटेंशन को फिर से खोल सकते हैं।",
    importFileClose: "बंद करें",
    importFileHint: "GitHub Unfollowers द्वारा निर्यात की गई आपकी व्हाइटलिस्ट और क्रिया इतिहास को पुनर्स्थापित करता है।",
    importStepFile: "फ़ाइल",
    importStepConfirm: "पुष्टि करें",
    importStepDone: "पूर्ण",
  ...
  ar: {
    ...
    importDo: "استيراد",
    importFileTitle: "استيراد ملف نسخ احتياطي",
    importFilePick: "اختر ملفًا",
    importFileDragHint: "أو اسحب ملف .json وأفلته هنا",
    importFileSelected: "الملف المحدد",
    importFileDone: "اكتمل الاستيراد!",
    importFileSuccessHint: "تمت استعادة بياناتك. يمكنك إغلاق هذه التبويب وإعادة فتح الإضافة.",
    importFileClose: "إغلاق",
    importFileHint: "يستعيد قائمتك البيضاء وسجل الإجراءات التي صدّرها GitHub Unfollowers.",
    importStepFile: "الملف",
    importStepConfirm: "تأكيد",
    importStepDone: "مكتمل",
  ...
  fr: {
    ...
    importDo: "Importer",
    importFileTitle: "Importer un fichier de sauvegarde",
    importFilePick: "Choisir un fichier",
    importFileDragHint: "ou glissez-déposez le fichier .json ici",
    importFileSelected: "Fichier sélectionné",
    importFileDone: "Importation terminée !",
    importFileSuccessHint: "Vos données ont été restaurées. Vous pouvez fermer cet onglet et rouvrir l'extension.",
    importFileClose: "Fermer",
    importFileHint: "Restaure votre liste blanche et votre historique d'actions exportés par GitHub Unfollowers.",
    importStepFile: "Fichier",
    importStepConfirm: "Confirmer",
    importStepDone: "Terminé",
  ...
  de: {
    ...
    importFileTitle: "Sicherungsdatei importieren",
    importFilePick: "Datei auswählen",
    importFileDragHint: "oder ziehe die .json-Datei hierher",
    importFileSelected: "Ausgewählte Datei",
    importFileDone: "Import abgeschlossen!",
    importFileSuccessHint: "Ihre Daten wurden wiederhergestellt. Sie können diesen Tab schließen und die Erweiterung erneut öffnen.",
    importFileClose: "Schließen",
    importFileHint: "Stellt Ihre Whitelist und den von GitHub Unfollowers exportierten Aktionsverlauf wieder her.",
    importStepFile: "Datei",
    importStepConfirm: "Bestätigen",
    importStepDone: "Abgeschlossen",
  ...
  ja: {
    ...
    importDo: "インポート",
    importFileTitle: "バックアップファイルをインポート",
    importFilePick: "ファイルを選択",
    importFileDragHint: "または .json ファイルをここにドラッグ＆ドロップ",
    importFileSelected: "選択したファイル",
    importFileDone: "インポートが完了しました！",
    importFileSuccessHint: "データが復元されました。このタブを閉じて、拡張機能を再度開くことができます。",
    importFileClose: "閉じる",
    importFileHint: "GitHub Unfollowers がエクスポートしたホワイトリストと操作履歴を復元します。",
    importStepFile: "ファイル",
    importStepConfirm: "確認",
    importStepDone: "完了",
  ...
  ru: {
    ...
    importDo: "Импортировать",
    importFileTitle: "Импорт файла резервной копии",
    importFilePick: "Выбрать файл",
    importFileDragHint: "или перетащите файл .json сюда",
    importFileSelected: "Выбранный файл",
    importFileDone: "Импорт завершен!",
    importFileSuccessHint: "Ваши данные восстановлены. Вы можете закрыть эту вкладку и снова открыть расширение.",
    importFileClose: "Закрыть",
    importFileHint: "Восстанавливает ваш белый список и историю действий, экспортированные GitHub Unfollowers.",
    importStepFile: "Файл",
    importStepConfirm: "Подтвердить",
    importStepDone: "Завершено",
  ...
  ko: {
    ...
    menuImport: "데이터 가져오기",
    importDo: "가져오기",
    importFileTitle: "백업 파일 가져오기",
    importFilePick: "파일 선택",
    importFileDragHint: "또는 .json 파일을 여기로 끌어다 놓으세요",
    importFileSelected: "선택한 파일",
    importFileDone: "가져오기 완료!",
    importFileSuccessHint: "데이터가 복원되었습니다. 이 탭을 닫고 확장 프로그램을 다시 열 수 있습니다.",
    importFileClose: "닫기",
    importFileHint: "GitHub Unfollowers가 내보낸 화이트리스트와 작업 기록을 복원합니다.",
    importStepFile: "파일",
    importStepConfirm: "확인",
    importStepDone: "완료",
  ...
  it: {
    ...
    importDo: "Importa",
    importFileTitle: "Importa file di backup",
    importFilePick: "Scegli file",
    importFileDragHint: "o trascina qui il file .json",
    importFileSelected: "File selezionato",
    importFileDone: "Importazione completata!",
    importFileSuccessHint: "I tuoi dati sono stati ripristinati. Puoi chiudere questa scheda e riaprire l'estensione.",
    importFileClose: "Chiudi",
    importFileHint: "Ripristina la tua lista bianca e la cronologia delle azioni esportate da GitHub Unfollowers.",
    importStepFile: "File",
    importStepConfirm: "Conferma",
    importStepDone: "Completato",
    importSuccess: "Dati importati correttamente.",
  ...
  tr: {
    ...
    importDo: "İçe aktar",
    importFileTitle: "Yedek dosyasını içe aktar",
    importFilePick: "Dosya seç",
    importFileDragHint: "veya .json dosyasını buraya sürükleyin",
    importFileSelected: "Seçilen dosya",
    importFileDone: "İçe aktarma tamamlandı!",
    importFileSuccessHint: "Verileriniz geri yüklendi. Bu sekmeyi kapatıp uzantıyı yeniden açabilirsiniz.",
    importFileClose: "Kapat",
    importFileHint: "GitHub Unfollowers tarafından dışa aktarılan beyaz listenizi ve işlem geçmişinizi geri yükler.",
    importStepFile: "Dosya",
    importStepConfirm: "Onayla",
    importStepDone: "Tamamlandı",
  ...
  vi: {
    ...
    importDo: "Nhập",
    importFileTitle: "Nhập tệp sao lưu",
    importFilePick: "Chọn tệp",
    importFileDragHint: "hoặc kéo và thả tệp .json vào đây",
    importFileSelected: "Tệp đã chọn",
    importFileDone: "Đã nhập xong!",
    importFileSuccessHint: "Dữ liệu của bạn đã được khôi phục. Bạn có thể đóng tab này và mở lại tiện ích mở rộng.",
    importFileClose: "Đóng",
    importFileHint: "Khôi phục danh sách trắng và lịch sử hành động do GitHub Unfollowers xuất ra.",
    importStepFile: "Tệp",
    importStepConfirm: "Xác nhận",
    importStepDone: "Hoàn tất",
  ...
  pl: {
    ...
    importDo: "Importuj",
    importFileTitle: "Importuj plik kopii zapasowej",
    importFilePick: "Wybierz plik",
    importFileDragHint: "lub przeciągnij i upuść plik .json tutaj",
    importFileSelected: "Wybrany plik",
    importFileDone: "Import zakończony!",
    importFileSuccessHint: "Twoje dane zostały przywrócone. Możesz zamknąć tę kartę i ponownie otworzyć rozszerzenie.",
    importFileClose: "Zamknij",
    importFileHint: "Przywraca Twoją białą listę i historię działań wyeksportowaną przez GitHub Unfollowers.",
    importStepFile: "Plik",
    importStepConfirm: "Potwierdź",
    importStepDone: "Zakończone",
  ...
  nl: {
    ...
    importDo: "Importeren",
    importFileTitle: "Back-upbestand importeren",
    importFilePick: "Bestand kiezen",
    importFileDragHint: "of sleep het .json-bestand hierheen",
    importFileSelected: "Geselecteerd bestand",
    importFileDone: "Importeren voltooid!",
    importFileSuccessHint: "Uw gegevens zijn hersteld. U kunt dit tabblad sluiten en de extensie opnieuw openen.",
    importFileClose: "Sluiten",
    importFileHint: "Herstelt uw whitelist en actiegeschiedenis die door GitHub Unfollowers zijn geëxporteerd.",
    importStepFile: "Bestand",
    importStepConfirm: "Bevestigen",
    importStepDone: "Voltooid",
